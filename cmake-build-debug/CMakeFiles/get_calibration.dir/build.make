...
CMakeFiles/get_calibration:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=C:\Users\carlos\Dropbox\Projetos\Estacao_de_solda\Codigo\SolderingStationFirmware\cmake-build-debug\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Write calibration status of internal oscillator to ATMEGA328P_calib.tmp."
	"C:\Program Files (x86)\Arduino Programmer\avrdude.exe" -p ATMEGA328P -c arduino -P COM7 -U calibration:r:ATMEGA328P_calib.tmp:r
