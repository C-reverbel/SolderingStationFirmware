...
CMakeFiles/upload_eeprom: alc-ATMEGA328P-eeprom.hex
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=C:\Users\carlos\Dropbox\Projetos\Estacao_de_solda\Codigo\SolderingStationFirmware\cmake-build-release\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Uploading alc-ATMEGA328P-eeprom.hex to ATMEGA328P using arduino"
	"C:\Program Files (x86)\Arduino Programmer\avrdude.exe" -p ATMEGA328P -c arduino -b 115200 -D -U eeprom:w:alc-ATMEGA328P-eeprom.hex -P COM7
